  ...
  return (
    <article className="card overflow-hidden">
      ...
      <div className="space-y-3 p-4">
        ...
        <p className="text-sm text-[var(--text-soft)]">{contest.description?.slice(0, 95)}...</p>
        ...
        <Link to={`/contest/${contest._id}`} className="btn btn-primary inline-flex w-full items-center justify-center">
          Details
        </Link>
      </div>
    </article>
